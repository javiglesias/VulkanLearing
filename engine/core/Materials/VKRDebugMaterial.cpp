...
namespace VKR
{
	namespace render
	{
		...
		void R_DbgMaterial::CreateDescriptorPool(VkDevice _LogicDevice)
		{
		...
		void R_DbgMaterial::CreateMeshDescriptorSet(VkDevice _LogicDevice, VkDescriptorSetLayout _DescSetLayout)
		{
		...
		void R_DbgMaterial::UpdateDescriptorSet(VkDevice _LogicDevice, std::vector<VkBuffer> _UniformBuffers, std::vector<VkBuffer> _DynamicBuffers)
		{
