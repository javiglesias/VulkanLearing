...
extern bool VKR::render::m_CloseEngine;
extern bool VKR::render::m_MouseCaptured;
inline void 
init_input_devices(
#ifndef USE_GLFW
...
{
	if (_button == GLFW_MOUSE_BUTTON_RIGHT && _action == GLFW_PRESS && !VKR::render::m_MouseCaptured)
	{
		VKR::render::m_MouseCaptured = true;
	}
	if (_button == GLFW_MOUSE_BUTTON_LEFT && _action == GLFW_PRESS && VKR::render::m_MouseCaptured)
	{
		VKR::render::m_MouseCaptured = false;
	}
}
